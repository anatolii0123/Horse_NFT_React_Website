				...
				<Container>
					...
					<Grid container>
						<Grid item sm={12} lg={6} md={6}>
							<Item>
								<img src={coinLogo} alt="NoImg" className="center_container" />
							</Item>
						</Grid>
						<Grid item sm={12} lg={6} md={6}>
							<Item className="center_container center" >
								...
								<br />
								<span className="x_font_y_3">Stable Solution</span>
								<br />
			...
			<Container>
				...
				<div className="part3">
					<Item>
						...
						<br />
						<span className="x_font_y_3"><b>Roadmap</b> of Full Management of Token</span>
						...
						<Grid container justifyContent="center" alignItems="center" spacing={5}>
							<Grid item md={3} sm={12}>
								...
								<InfoCard
									...
									content={(<span>Presale start. <br />  Add list to DEX. <br /> launch white paper</span>)}
								/>
							</Grid>
							<Grid item md={3} sm={12}>
